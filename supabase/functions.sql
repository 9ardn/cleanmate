...
begin
  ...
  insert into public.verifications (task_id, party_id, requested_by, photo_placeholder, status)
  values (p_task_id, v_task.party_id, v_user_id, p_photo_placeholder, 'pending')
